...
export const metadata = {
  ...
  description: 'Découvrez le nouveau site web PKBA - Parkour Bassin d\'Arcachon ! Lancement officiel le 15 août 2025 avec pré-inscriptions en ligne, boutique intégrée et fonctionnalités modernes pour la communauté parkour.',
  keywords: 'PKBA, Parkour Bassin d\'Arcachon, nouveau site web, lancement 2025, pré-inscriptions en ligne, boutique parkour, communauté parkour, actualités PKBA',
  openGraph: {
