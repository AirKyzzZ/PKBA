...
export const metadata = {
  title: 'Nouveau Site Web PKBA - Lancement 15 Août 2025 | Actualités PKBA',
      description: 'Découvrez le nouveau site web PKBA - Parkour Bassin d\'Arcachon ! Lancement officiel le 15 août 2025 avec préinscriptions en ligne, boutique intégrée et fonctionnalités modernes pour la communauté parkour.',
      keywords: 'PKBA, Parkour Bassin d\'Arcachon, nouveau site web, lancement 2025, préinscriptions en ligne, boutique parkour, communauté parkour, actualités PKBA',
  openGraph: {
