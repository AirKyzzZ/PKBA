      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white rounded-xl p-5 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300 flex-shrink-0">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 sm:mt-20 bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-6 sm:p-8 lg:p-12 text-white"
        >
          <div className="text-center mb-10">
            <h3 className="text-3xl md:text-4xl font-cheddar font-bold mb-3">
              PKBA en chiffres
            </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-4xl md:text-5xl font-cheddar font-bold mb-2 text-primary">
                  {stat.number}
                </div>
                <div className="text-white/60 font-montserrat font-medium text-sm">
                  {stat.label}
                </div>
              </motion.div>
            ))}
