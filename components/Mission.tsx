          ...
          {missionPoints.map((point, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className={`w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center ${point.color}`}>
                  <point.icon size={32} />
                </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="space-y-3 font-montserrat text-gray-600">
            ...
            <div className="bg-gradient-to-br from-primary to-secondary rounded-lg p-8 text-white">
              <h4 className="text-2xl font-cheddar font-bold mb-4">
                Saison 2025/2026
              </h4>
              <p className="font-montserrat text-white/90 leading-relaxed">
                ...
                Pré-inscriptions ouvertes pour tous les niveaux, à partir de 6 ans (avec autorisation parentale pour les mineurs).
              </p>
            </div>
          </div>
        </motion.div>
